...
; FLASH
		...
		.org	0x001E	; Timer5 Compare Match A
		jmp TIMER1_COMPA
...
reset:		
		...
		outi	TCCR1A, 0x00
		outi	TCCR1B, (1 << WGM12) | (1 << CS12) | (1 << CS10)	; CTC mode & Prescaler @ 1024
		outi	TIMSK1, (1 << OCIE1A)	; permition for compare interrupt
		outi	OCR1AH, 0x2A	; 0.7 sec
		outi	OCR1AL, 0xB9
		
		sei	; enable interrupts

main:		
		sbic	PINL, 1	; if button1 is pressed (bit1 == LOW)
		rjmp	endButton1
		clr		_counter1
...
endButton1:
		...
		sbic	PINL, 3	; if button2 is pressed (bit3 == LOW)
		rjmp	endButton2
		clr		_counter2
